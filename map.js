...
// ─── COUNTRY NAMES ───────────────────────────
// "topoJsonId": "Name"  ← name must match key in data.json
// Hover any country → bottom-right shows its topo id
const COUNTRY_NAMES = {
  "004": "Afghanistan",   "008": "Albania", "010": "Artanctica",         "012": "Algeria",
  "016": "American Samoa","024": "Angola",
  "028": "Antigua and Barbuda", "031": "Azerbaijan", "032": "Argentina",
  "036": "Australia",     "040": "Austria",          "044": "Bahamas",
  "048": "Bahrain",       "050": "Bangladesh",       "051": "Armenia",
  "052": "Barbados",      "056": "Belgium",          "060": "Bermuda",
  ...
  "188": "Costa Rica",    "191": "Croatia",          "192": "Cuba",
  "196": "Cyprus",        "203": "Czechia",          "204": "Benin",
  "208": "Denmark",       "214": "Dominican Republic","218": "Ecuador",
  "222": "El Salvador",   "226": "Equatorial Guinea","231": "Ethiopia",
  "232": "Eritrea",       "233": "Estonia",          "242": "Fiji",
  ...
  "528": "Netherlands",   "548": "Vanuatu",          "554": "New Zealand",
  "558": "Nicaragua",     "562": "Niger",            "566": "Nigeria",
  "578": "Norway",        "583": "Micronesia",       "584": "Marshall Islands",
  "585": "Palau",         "586": "Pakistan",         "591": "Panama",
  "598": "Papua New Guinea","600": "Paraguay",       "604": "Peru",
  "608": "Philippines",   "616": "Poland",           "620": "Portugal",
  "624": "Guinea-Bissau", "626": "Timor-Leste",      "634": "Qatar",
  ...
  "728": "South Sudan",   "729": "Sudan",            "740": "Suriname",
...
async function init() {
  ...
  // Clip to sphere so countries can't scroll outside the globe
  ...
  // Constrained zoom — prevents infinite scrolling
  const zoom = d3.zoom()
    .scaleExtent([1, 12])
